...
class Pagination{
   ...
   var $numLinks        =  2;
   var $currentPage    =  0;
   var $firstLink       = '<i class="simple-icon-control-start"></i>';
   var $nextLink        = '<i class="simple-icon-arrow-right"></i>';
   var $prevLink        = '<i class="simple-icon-arrow-left"></i>';
   var $lastLink        = '<i class="simple-icon-control-end"></i>';
   var $fullTagOpen    = '  <ul class="pagination justify-content-center mb-0">';
   var $fullTagClose    = '</ul>';
   ...
   var $curTagOpen        = '<li class="page-item active">
                                <a class="page-link" href="javascript:void(0)"><b>';
   var $curTagClose    = '          </b>
                                 </a>
                            </li>';
